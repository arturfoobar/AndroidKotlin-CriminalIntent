...
import pl.example.criminalintentkt.databinding.FragmentCrimeDetailBinding
import java.io.File
import java.util.Date
private const val DATE_FORMAT = "EEEE d LLLL yyyy"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            crimeCamera.setOnClickListener {
                ...
                val photoUri = FileProvider.getUriForFile(requireContext(), "pl.example.criminalintentkt.fileprovider", photoFile)
    ...
    private fun updateUI(crime: Crime) {
        binding.apply {
            ...
            crimeReport.setOnClickListener {
                ...
                // Opcjonalnie można dodać chooser
